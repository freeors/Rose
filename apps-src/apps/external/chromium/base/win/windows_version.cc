...
OSInfo::VersionNumber OSInfo::Kernel32VersionNumber() const {
  ...
  static const VersionNumber version = {
      .major = (int)Kernel32BaseVersion().components()[0],
      .minor = (int)Kernel32BaseVersion().components()[1],
      .build = (int)Kernel32BaseVersion().components()[2],
      .patch = (int)Kernel32BaseVersion().components()[3]};
  return version;
}
