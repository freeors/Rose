 ...
 public:
  class BASE_EXPORT Delegate {
   public:
    ...
    virtual void SetRequireDeletePendingTasks(base::WaitableEvent& e) = 0;
  };
  ...
  void SetRequireDeletePendingTasks(base::WaitableEvent& e) {
      DCHECK(delegate_);
      delegate_->SetRequireDeletePendingTasks(e);
  }
