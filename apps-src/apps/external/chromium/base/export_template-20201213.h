...
#define EXPORT_TEMPLATE_DECLARE_MSVC_HACK(foo_export, _)
#define EXPORT_TEMPLATE_DEFINE_MSVC_HACK(foo_export, _) foo_export
...
#define EXPORT_TEMPLATE_TEST(want, foo_export)                                 \
  static_assert(EXPORT_TEMPLATE_INVOKE(                                    \
                    TEST_##want, EXPORT_TEMPLATE_STYLE(foo_export, ), foo_export), \
                #export)
