...
#define EXPORT_TEMPLATE_DECLARE_DEFAULT(foo_export, _) foo_export
#define EXPORT_TEMPLATE_DEFINE_DEFAULT(foo_export, _)

// The "declspec" style is used when FOO_EXPORT is defined
// as __declspec(dllexport), which MSVC requires to be used at
// definition sites instead.
#define EXPORT_TEMPLATE_DECLARE_EXPORT_DLLEXPORT(foo_export, _)
#define EXPORT_TEMPLATE_DEFINE_EXPORT_DLLEXPORT(foo_export, _) foo_export
...
//     DEFAULT
#define EXPORT_TEMPLATE_STYLE(foo_export, _) EXPORT_TEMPLATE_STYLE_2(foo_export, )
#define EXPORT_TEMPLATE_STYLE_2(foo_export, _) \
...
#define EXPORT_TEMPLATE_TEST(want, foo_export)                               \
  static_assert(                                                             \
      EXPORT_TEMPLATE_INVOKE(TEST_##want, EXPORT_TEMPLATE_STYLE(foo_export, ), foo_export), \
      #foo_export)
