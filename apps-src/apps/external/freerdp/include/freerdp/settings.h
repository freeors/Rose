...
#define FreeRDP_ServerOsMajorType (2313)
#define FreeRDP_ServerOsMinorType (2314)
...
struct rdp_settings
{
	...
	ALIGN64 UINT32 ServerOsMajorType;       /* 2313 */ // Valid only Client. Client has only one rdp_settings.
	ALIGN64 UINT32 ServerOsMinorType;       /* 2314 */ // Valid only Client. Client has only one rdp_settings.
	UINT64 padding2368[2368 - 2315];        /* 2315 */
