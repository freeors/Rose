...
static BOOL autodetect_recv_rtt_measure_response2(rdpContext* context, UINT16 sequenceNumber)
{
	context->autodetect->lastSequenceNumber = sequenceNumber;
	return TRUE;
}
...
{
	autodetect->RTTMeasureRequest = autodetect_send_connecttime_rtt_measure_request; // autodetect_send_continuous_rtt_measure_request;
	autodetect->RTTMeasureResponse = autodetect_recv_rtt_measure_response2;
