...
FREERDP_LOCAL wStream* nego_get_negotiation_request(rdpNego* nego);
FREERDP_LOCAL BOOL nego_recv_cc(rdpNego* nego);
FREERDP_LOCAL BOOL rdp_client_connect_mcs(rdpRdp* rdp);
FREERDP_LOCAL BOOL nego_send_negotiation_response(rdpNego* nego);
FREERDP_LOCAL int rose_did_read(rdpRdp* rdp);
