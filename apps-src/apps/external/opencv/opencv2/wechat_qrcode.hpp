...
public:
     ...
     */
    CV_WRAP WeChatQRCode(const char* detector_prototxt_data = nullptr, size_t detector_prototxt_len = 0,
                         const char* detector_caffe_model_data = nullptr, size_t detector_caffe_model_len = 0,
                         const char* super_resolution_prototxt_data = nullptr, size_t super_resolution_prototxt_len = 0,
                         const char* super_resolution_caffe_model_data = nullptr, size_t super_resolution_caffe_model_len = 0);
    ~WeChatQRCode(){};
