...
#ifdef __ARM_NEON__
    // SDL_Log("fastAtan32f, defined __ARM_NEON__");
#endif
    
#ifdef __ARM_NEON
    // SDL_Log("fastAtan32f, defined __ARM_NEON");
#endif

    bool carotene = CAROTENE_NS::isSupportedConfiguration();
#ifndef _WIN32
    // SDL_Log("fastAtan32f, [1]CALL_HAL, carotene: %s", carotene? "true": "false");
#endif
    CALL_HAL(fastAtan32f, cv_hal_fastAtan32f, Y, X, angle, len, angleInDegrees);
#ifndef _WIN32
    // SDL_Log("fastAtan32f, [2]CALL_HAL not impletement, use CV_CPU_DISPATCH, carotene: %s", carotene? "true": "false");
#endif
