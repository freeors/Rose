...
int SuperScale::init(const char* proto_data, size_t proto_size, const char* model_data, size_t model_size) {
    srnet_ = dnn::readNetFromCaffe(proto_data, proto_size, model_data, model_size);
    net_loaded_ = true;
    return 0;
}
