...
BasicUsageEnvironment::BasicUsageEnvironment(TaskScheduler& taskScheduler, bool use_chromium, int id, bool send_rtcp)
: BasicUsageEnvironment0(taskScheduler, use_chromium, id, send_rtcp) {
#if defined(__WIN32__) || defined(_WIN32)
...
BasicUsageEnvironment*
BasicUsageEnvironment::createNew(TaskScheduler& taskScheduler, bool use_chromium, int id, bool send_rtcp) {
  return new BasicUsageEnvironment(taskScheduler, use_chromium, id, send_rtcp);
}
