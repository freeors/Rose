...
#include "BasicUsageEnvironment/include/BasicUsageEnvironment0.hh"
#endif

class BasicUsageEnvironment: public BasicUsageEnvironment0 {
public:
  static BasicUsageEnvironment* createNew(TaskScheduler& taskScheduler, bool use_chromium, int id, bool send_rtcp);
...
protected:
  BasicUsageEnvironment(TaskScheduler& taskScheduler, bool use_chromium, int id, bool send_rtcp);
