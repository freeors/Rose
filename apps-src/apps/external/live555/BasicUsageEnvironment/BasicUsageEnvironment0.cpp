...
BasicUsageEnvironment0::BasicUsageEnvironment0(TaskScheduler& taskScheduler, bool use_chromium, int id, bool send_rtcp)
  : UsageEnvironment(taskScheduler, use_chromium, id, send_rtcp),
