...
public:
  ...
  const std::string& httpdUrl() const { return fHttpdUrl; }
...
protected:
  ...
  Boolean parseSDPAttribute_http(char const* sdpLine);
...
public:
  ...
  Boolean initiate(int useSpecialRTPoffset = -1, bool useChromium = false);
...
protected:
  ...
  virtual Boolean createSourceObjects(int useSpecialRTPoffset, bool useChromium);
