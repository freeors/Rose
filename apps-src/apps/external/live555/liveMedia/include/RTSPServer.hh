...
public: // should be protected, but some old compilers complain otherwise
  ...
  protected: // redefined virtual functions:
	...
	virtual int handleRequestBytes_chromium(int connection_id, const char* buf, int buf_len);
  ...
  protected:
	...
	net::StreamSocket* fClientNetSock;
    Boolean fIsActive;
...
protected: // redefined virtual functions
  ...
  virtual ClientConnection* createNewClientConnection(int clientSocket, struct sockaddr_in clientAddr, net::StreamSocket* netSock, int sessionid);
...
private:
  ...
  void noteTCPStreamingOnSocket(char const* key, RTSPClientSession* clientSession, unsigned trackNum);
  void unnoteTCPStreamingOnSocket(char const* key, RTSPClientSession* clientSession, unsigned trackNum);
  void stopTCPStreamingOnSocket(char const* key);
