...
public:
  ...
  Destinations(int tcpSockNum, net::StreamSocket* netSock, unsigned char rtpChanId, unsigned char rtcpChanId)
    : isTCP(True), rtpPort(0) /*dummy*/, rtcpPort(0) /*dummy*/,
      tcpSocketNum(tcpSockNum), tcpNetSock(netSock), rtpChannelId(rtpChanId), rtcpChannelId(rtcpChanId) {
  }
