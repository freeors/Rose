...
#include "liveMedia/include/RTSPServerSupportingHTTPStreaming.hh"
...
RTSPServerSupportingHTTPStreaming::createNewClientConnection(int clientSocket, struct sockaddr_in clientAddr, net::StreamSocket* netSock, int sessionid) {
  return new RTSPClientConnectionSupportingHTTPStreaming(*this, clientSocket, clientAddr, netSock, sessionid);
}

RTSPServerSupportingHTTPStreaming::RTSPClientConnectionSupportingHTTPStreaming
::RTSPClientConnectionSupportingHTTPStreaming(RTSPServer& ourServer, int clientSocket, struct sockaddr_in clientAddr, net::StreamSocket* netSock, int sessionid)
  : RTSPClientConnection(ourServer, clientSocket, clientAddr, netSock, sessionid),
...
::handleHTTPCmd_StreamingGET(char const* urlSuffix, char const* /*fullRequestStr*/) {
  ...
  do {
	...
	break;
      ...
      void* streamToken;
      subsession->getStreamParameters(fClientSessionId, 0, clientRTPPort,clientRTCPPort, -1, nullptr, 0,0, destinationAddress,destinationTTL, isMulticast, serverRTPPort,serverRTCPPort, streamToken);
