...
#include "liveMedia/include/FramedSource.hh"
#include <stdlib.h>
...
void FramedSource::getNextFrame(unsigned char* to, unsigned maxSize,
  ...
  dbg_variable.isCurrentlyAwaitingData = True;

  doGetNextFrame();
}

void FramedSource::cancelGetNextFrame()
{
	if (fIsCurrentlyAwaitingData) {
		// cancelGetNextFrame maybe execute after afterGettingFrame, at this time, fIsCurrentlyAwaitingData = false.
		fIsCurrentlyAwaitingData = False;
		dbg_variable.isCurrentlyAwaitingData = False;
	}
}

void FramedSource::afterGetting_chromium(int sessionid, FramedSource* source)
{
