...
#include "liveMedia/include/H264or5VideoRTPSink.hh"
#include "liveMedia/include/H264or5VideoStreamFramer.hh"
...
::H264or5VideoRTPSink(int hNumber,
  ...
  : VideoRTPSink(env, RTPgs, rtpPayloadFormat, 90000, hNumber == 264 ? "H264" : "H265", isLiveVideo),
