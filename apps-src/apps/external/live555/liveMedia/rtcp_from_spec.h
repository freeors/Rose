...
EXTERN void OnExpire _ANSI_ARGS_((event_spec, int, int, double, int, double*, int*, time_tp, time_tp*, int*));

EXTERN void OnReceive _ANSI_ARGS_((packet, event_spec, int*, int*, int*, double*, double*, double, double));

/* IMPORTS: */

EXTERN void Schedule _ANSI_ARGS_((double,event_spec));
EXTERN void Reschedule _ANSI_ARGS_((double,event_spec));
EXTERN void SendRTCPReport _ANSI_ARGS_((event_spec));
EXTERN void SendBYEPacket _ANSI_ARGS_((event_spec));
EXTERN int TypeOfEvent _ANSI_ARGS_((event_spec));
EXTERN int SentPacketSize _ANSI_ARGS_((event_spec));
