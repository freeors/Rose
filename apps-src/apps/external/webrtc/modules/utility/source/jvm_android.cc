...
struct {
  ...
  {"org/libsdl/app/SmsSmart", nullptr},
#endif
};
...
#ifndef _KOS
  // chromium
  context_utils = FindClass(jni, "org/chromium/base/ContextUtils");
  initialize_method = jni->GetStaticMethodID(
      context_utils, "initApplicationContext", "(Landroid/content/Context;)V");
  jni->CallStaticVoidMethod(context_utils, initialize_method, context);
#endif
}
