...
public:
	...
	explicit tlinked_group2(const unit& u, const std::vector<tlinked_group>& linked_groups);
...
private:
	...
	void item_selected(twindow& window, tlistbox& listobx);
	void click_append(twindow& window);
