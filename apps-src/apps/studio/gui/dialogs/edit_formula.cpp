...
#include "gui/dialogs/edit_formula.hpp"
...
REGISTER_DIALOG(studio, edit_formula)

tedit_formula::tedit_formula()
{
}

void tedit_formula::pre_show()
{
...
/*
	...
	ss.str("");
	ss << "ROW#" << ht::generate_format(u_.get_location().x, "yellow"); 
...
void tedit_formula::save(twindow& window, bool& handled, bool& halt)
{
/*
	ttext_box* text_box = find_widget<ttext_box>(&window, "_grow_factor", false, true);
