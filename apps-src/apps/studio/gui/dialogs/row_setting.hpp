...
#ifndef GUI_DIALOGS_ROW_SETTING_HPP_INCLUDED
#define GUI_DIALOGS_ROW_SETTING_HPP_INCLUDED
...
class trow_setting : public tsetting_dialog
{
public:
	explicit trow_setting(const unit& u);
