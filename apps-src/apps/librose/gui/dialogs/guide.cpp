...
void tguide_::pre_show()
{
	...
	track_->set_did_draw(std::bind(&tguide::did_draw_image, this, _1, _2, _3, 0));
	track_->set_did_mouse_leave(std::bind(&tguide::callback_control_drag_detect, this, _1, _2, _3));
	track_->set_did_mouse_motion(std::bind(&tguide::callback_set_drag_coordinate, this, _1, _2, _3));
...
{
	window_->set_label("dialogs/white_background.png");
