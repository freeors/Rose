...
public:
	...
	void set_did_selector_changed(const std::function<bool (ttoggle_button&, const int, const std::vector<bool>& )>& did)
	{
...
private:
	...
	std::function<bool (ttoggle_button&, const int, const std::vector<bool>& )> did_selector_changed_;
