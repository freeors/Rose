...
private:
	...
	void post_blit(const SDL_Rect& widget_rect, int left_sel, const SDL_Rect& left_src, const SDL_Rect& left_dst, int right_sel, const SDL_Rect& right_src, const SDL_Rect& right_dst) override;
	void set_retval(twindow& window, int retval) override;
