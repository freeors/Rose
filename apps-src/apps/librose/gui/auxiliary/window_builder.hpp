 ...
 */
twindow* build(tdialog& dlg, CVideo& video, const std::string& type, const unsigned explicit_x, const unsigned explicit_y);
 ...
 * Builds a window.
 */
twindow* build(tdialog& dlg, CVideo &video, const twindow_builder::tresolution *res, const unsigned explicit_x, const unsigned explicit_y);
