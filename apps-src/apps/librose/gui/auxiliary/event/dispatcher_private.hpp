/* $Id: dispatcher_private.hpp 52533 2012-01-07 02:35:17Z shadowmaster $ */
/*
...
#define IMPLEMENT_EVENT_SIGNAL_WRAPPER(TYPE)                                  \
	...
	IMPLEMENT_EVENT_SIGNAL_WRAPPER(textinput)
...
inline bool fire_event(const tevent event
		...
		, F functor)
{
	twidget::tfire_event_widget_lock lock(*widget);
