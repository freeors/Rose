...
tslider_definition::tresolution::tresolution(const config& cfg)
	...
	, minimum_positioner_length(cfg["minimum_positioner_length"].to_int() * twidget::hdpi_scale)
	, maximum_positioner_length(cfg["maximum_positioner_length"].to_int() * twidget::hdpi_scale)
 ...
 */
	...
	if (twidget::hdpi_scale) {
		minimum_positioner_length *= twidget::hdpi_scale;
		maximum_positioner_length *= twidget::hdpi_scale;
		left_offset *= twidget::hdpi_scale;
		right_offset*= twidget::hdpi_scale;
	}
