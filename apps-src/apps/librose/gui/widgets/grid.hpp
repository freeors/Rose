...
public:
	...
	bool require_invalidate_layout(const tcontrol& from) const;
...
public:
	...
	/** Inherited from twidget.*/
	bool has_widget(const twidget* widget) const override;
...
private:
	...
	bool is_grid() const override { return true; }
