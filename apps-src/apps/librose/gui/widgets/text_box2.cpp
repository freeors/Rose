...
ttext_box2::ttext_box2(twindow& window, twidget& widget, const std::string& panel_border, const std::string& image_label, bool desensitize, const std::string& button_label, bool clear)
