...
public:
	...
	/***** ***** ***** ***** layout functions ***** ***** ***** *****/
	const tgrid& layout_grid() const override { return *content_grid_; }
	...
	void set_did_pullrefresh(const int refresh_height, const std::function<void (ttrack&, const SDL_Rect&)>& did_refresh,
		const int min_drag2_height = nposm, const std::function<void (ttrack&, const SDL_Rect&)>& did_drag1 = NULL, const std::function<void (ttrack&, const SDL_Rect&)>& did_drag2 = NULL);

	void set_unrestricted_drag(bool enable) { unrestricted_drag_ = enable; }
...
private:
	...
	void broadcast_frame_buffer(texture& frame_buffer) override;
...
private:
	...
	std::function<void (ttrack&, const SDL_Rect&)> did_pullrefresh_drag1_;
	std::function<void (ttrack&, const SDL_Rect&)> did_pullrefresh_drag2_;
	std::function<void (ttrack&, const SDL_Rect&)> did_pullrefresh_refresh_;
