...
namespace settings {
	...
	extern std::string track_id;
	extern std::string button_id;
...
struct tgui_definition
{
	tgui_definition()
		...
		, keyboard_vertical_scrollbar(nullptr)
		, keyboard_horizontal_scrollbar(nullptr)
	{
	}
	...
	std::unique_ptr<twidget> keyboard_widget;
	tfloat_widget* keyboard_vertical_scrollbar;
	tfloat_widget* keyboard_horizontal_scrollbar;
	// std::unique_ptr<tkeyboard> keyboard;

	void load_widget_definitions(const std::string& definition_type, const std::vector<tcontrol_definition_ptr>& definitions);
	void create_keyboard_widget(tfloat_widget* vertical, tfloat_widget* horizontal);
	void clear_texture();
};
