...
void tscroll_text_box::mini_finalize_subclass()
{
	...
	tb_->set_did_text_changed(std::bind(&tscroll_text_box::did_text_changed, this, _1));
	tb_->set_did_cursor_moved(std::bind(&tscroll_text_box::did_cursor_moved, this, _1));
}
