...
public:
	...
	{
	public:
		tsort_func(const std::function<bool (const ttree_node&, const ttree_node&)>& did_compare)
	...
	private:
		const std::function<bool (const ttree_node&, const ttree_node&)>& did_compare_;
	};

	void sort_children(const std::function<bool (const ttree_node&, const ttree_node&)>& did_compare);
