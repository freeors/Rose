...
public:
	...
	void set_did_refreshing(const std::function<void ()>& fn) { did_refreshing_ = fn; }
	void set_did_can_drag(const std::function<bool ()>& fn) { did_can_drag_ = fn; }
...
private:
	...
	std::function<void ()> did_refreshing_;
	std::function<bool ()> did_can_drag_;
