...
public:
	...
	/** Inherited from tselectable_. */
	void set_did_state_pre_change(const std::function<bool (ttoggle_button&)>& callback)
		{ did_state_pre_change_ = callback; }

	/** Inherited from tselectable_. */
	void set_did_state_changed(const std::function<void (ttoggle_button&)>& callback)
...
private:
	...
	std::function<bool (ttoggle_button&)> did_state_pre_change_;

	/** See tselectable_::set_did_state_changed. */
	std::function<void (ttoggle_button&)> did_state_changed_;
