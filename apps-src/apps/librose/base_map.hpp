...
public:
	...
	base_map(base_controller& controller, const tmap& gmap, bool consistent);
...
// ~~~ End iterator code ~~~
	 ...
	 * tmap somewhere, the iterator will be valid.
	...
	base_controller& get_controller() { return controller_; }
	const base_controller& get_controller() const { return controller_; }
	...
	virtual void sort_map(base_unit& u);
	...
	base_unit* find_base_unit(const int at) { return map_[at]; }
