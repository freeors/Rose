/* $Id: halo.hpp 47260 2010-10-28 21:06:10Z mordante $ */
/*
 ...
 */
int add(int x, int y, bool screen, const std::string& image, const map_location& loc, ORIENTATION orientation = NORMAL, bool infinite = true);
int add(int x, int y, bool screen, const image::tblit& blit, const map_location& loc = map_location(-1, -1));
