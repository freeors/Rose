#ifndef SDL_ROTATE_INCLUDED
#define SDL_ROTATE_INCLUDED
...
extern void SDLgfx_rotozoomSurfaceSizeTrig2(int width, int height, double cangle, double sangle, int* dstwidth, int* dstheight);
