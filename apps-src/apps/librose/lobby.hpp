...
public:
	...
	public:
		...
		void set_host(const std::string& host, int port) override;
		void reset_connect() override;

		// impletement ichat
		void tcp_send_len(char* buf, int len) override;
		void handle_command(const char* param[]) override;
		...
		bool erase_noresponse_msg(int major, const std::string& minor) override;
	...
	public:
		...
		{}
		void process() override;
		bool ready() const override { return socket_.get() != nullptr; }
		void reset_connect() override;
	...
	public:
		...
		void process() override;
		bool connect(int family, int type, const std::string& host, int port) override;
		void pre_disconnect() override;
		void post_disconnect() override;
		bool receive_probed() override;
