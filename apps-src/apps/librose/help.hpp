...
std::string get_first_word(const std::string& s, int font_sz, int style, int max_width);
...
void init_book(const config* game_cfg, tmap* map, bool editor);
void clear_book();
