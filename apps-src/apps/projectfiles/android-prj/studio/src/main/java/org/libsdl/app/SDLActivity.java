...
public class SDLActivity extends Activity implements View.OnSystemUiVisibilityChangeListener {
    ...
    public static int getDpiScale(Context context) {
        ...
        if (hdpi_scale > 2) {
            // I think, all android's hdpi must be 1 or 2.
            hdpi_scale = 2;
        }
    ...
    public static void reboot() {
        Intent intent = new Intent("com.android.intent.reboot");
        // intent.putExtra("enable" , true);
        mSingleton.sendBroadcast(intent);
    }

    public static void shutdown() {
        Intent intent = new Intent("com.android.intent.shutdown");
        // intent.putExtra("enable" , true);
        mSingleton.sendBroadcast(intent);
    }
